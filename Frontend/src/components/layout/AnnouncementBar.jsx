        ...
        <div className="bg-black text-white py-2 overflow-hidden relative z-50">
            <div className="flex justify-center items-center">
                ...
                <div className="md:hidden w-full overflow-hidden whitespace-nowrap">
                    ...
                    >
                        <span className="mx-4 text-xs font-bold tracking-wider uppercase">
                            {announcements.join(" • ")}
                        </span>
                    </motion.div>
                </div>
                ...
                <div className="hidden md:flex gap-8 items-center justify-center text-xs font-bold tracking-widest uppercase">
